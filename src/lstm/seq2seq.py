...
def validate(model: nn.Module, val_dl, criterion, device, merged_data, merged_targs):
        ...
        return loss_sum / len(val_dl), acc, corr
...
def fit(model, train_dl, val_dl, eps, opti, criterion, merged_data, merged_targs, device):
    ...
    for i in range(eps):
        ...
        val_loss, acc, corr = validate(model, val_dl, criterion, device, merged_data, merged_targs)
...
fit(model, dataloader_train, dataloader_val, eps, opti, criterion, merged_data, merged_targs, device)