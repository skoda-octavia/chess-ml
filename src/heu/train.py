...
if __name__ == "__main__":
    ...
    data_path = "data/prep/"
    x_file = data_path + "X.pt"
    y_file = data_path + "y.pt"


    for idx, layers in enumerate(model_weights):
        plt_path = f"plots/{idx}.png"
        weights_path = f"models/heus/{idx}/"
        ...
        model = Heu(6*8*8, 1, layers, dropout)
